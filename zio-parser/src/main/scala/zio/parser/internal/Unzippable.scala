...
// Based on zio.Unzippable, extended with UnzippableLeftIdentityAny
...
object Unzippable extends UnzippableLowPriority0 {

  type In[A, B, C] = Unzippable[A, B] { type In = C }

  implicit def UnzippableLeftIdentityAny[A]: Unzippable.In[Any, A, A] =
    new Unzippable[Any, A] {
      type In = A
...
trait UnzippableLowPriority0 extends UnzippableLowPriority1 {
